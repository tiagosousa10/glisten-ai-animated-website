...
/**
 * Item in *CaseStudies → Default → Primary → rZone*
 */
export interface CaseStudiesSliceDefaultPrimaryRzoneItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → rZone*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.rzone[].case_study
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * rZone field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.rzone[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  rzone: prismic.GroupField<Simplify<CaseStudiesSliceDefaultPrimaryRzoneItem>>;
}
...
/**
 * Item in *Integrations → Default → Primary → Repeatable*
 */
export interface IntegrationsSliceDefaultPrimaryRepeatableItem {
  /**
   * Icon field in *Integrations → Default → Primary → Repeatable*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.repeatable[].icon
...
export interface IntegrationsSliceDefaultPrimary {
  ...
  /**
   * Repeatable field in *Integrations → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.repeatable[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  repeatable: prismic.GroupField<
    Simplify<IntegrationsSliceDefaultPrimaryRepeatableItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      BentoSliceDefault,
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryRzoneItem,
      ...
      HeroSliceDefault,
      IntegrationsSlice,
      IntegrationsSliceDefaultPrimaryRepeatableItem,
